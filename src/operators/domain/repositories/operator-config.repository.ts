...
export abstract class OperatorConfigRepository {
    ...
    abstract findByOperator(operatorId: string): Promise<OperatorConfigEntity | null>;
    abstract updateByOperator(operatorId: string, data: Partial<OperatorConfigEntity>): Promise<OperatorConfigEntity | null>;
}