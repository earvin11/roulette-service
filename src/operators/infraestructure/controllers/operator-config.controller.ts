...
import { ApiResponse as SwaggerApiResponse, ApiTags } from '@nestjs/swagger';
...
export class OperatorConfigController {
    ...
    async create(
        ...
        const data = await this.operatorConfigUseCases.create({...createOperatorConfigDto, operator: operatorId.trim()});
